...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/izlazaksaautoputa.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/izlazaksaautoputa.exe: ${OBJECTFILES}
