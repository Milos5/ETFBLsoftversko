...
${OBJECTDIR}/ListOfPrices.o: ListOfPrices.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListOfPrices.o ListOfPrices.cpp
...
${OBJECTDIR}/menuOut.o: menuOut.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/menuOut.o menuOut.cpp
...
${OBJECTDIR}/ListOfPrices_nomain.o: ${OBJECTDIR}/ListOfPrices.o ListOfPrices.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListOfPrices_nomain.o ListOfPrices.cpp;\
	else  \
...
${OBJECTDIR}/menuOut_nomain.o: ${OBJECTDIR}/menuOut.o menuOut.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/menuOut_nomain.o menuOut.cpp;\
	else  \
...
${OBJECTDIR}/receipt_nomain.o: ${OBJECTDIR}/receipt.o receipt.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/receipt_nomain.o receipt.cpp;\
	else  \
